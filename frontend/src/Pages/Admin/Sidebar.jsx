    ...
    <div className='sidebar'>
      ...
      <div className="panel">
        <ul className='nav-menu'>
          ...
          <li onClick={()=>{setMenu("Manage Users")}}><img src={logo6} alt="User Icon" /><Link style={{textDecoration:'none',color:'#000000'}} to='/admin/manage-user'>Manage Users</Link>{menu==="ManageUserbyAdding"?<hr/>:<></>}</li>
